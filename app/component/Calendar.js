        ...
        <div className='w-full sm:w-4/5  mt-3 '>
            ...
            {formShow && <div className="bg-white rounded-xl shadow-[0_3px_10px_rgb(0,0,0,0.2)]    absolute z-30 w-1/2 lg:w-2/5 overflow-hidden" style={{ top: `${Coordinates[1] - 175}px`, left: `${Coordinates[0] - 670}px` }}>
                <div className='p-5 '>
                    ...
                    <div className=' w-full flex flex-col items-end'>
                        <form className='w-4/5 p-2'  >
                            ...
                            <div className='flex justify-between my-2'>
                                <button className='p-1  rounded-lg  bg-blue-100 text-blue-600  '>Event</button>
                                <button className='p-1  rounded-lg hover:bg-blue-100 hover:text-blue-600  '>Out of office</button>
                                <button className='p-1  rounded-lg hover:bg-blue-100 hover:text-blue-600  '>Task</button>
                                <button className='p-1  rounded-lg hover:bg-blue-100 hover:text-blue-600  '>Appointment</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div className='flex mx-5 my-2 items-center text-white' >
                        <i class="fi fi-rr-clock-three" style={{ display: 'hidden' }}></i>
                        <p className='sm:text-sm cursor-pointer text-blue-500 lg:text-lg sm:ml-3 lg:ml-5'>Find a Time</p>
                    </div>
                    <div className='flex mx-5 my-2 items-center text-gray-500' >
                        <i class="fi fi-rr-users"></i>
                        <p className='sm:text-sm  lg:text-lg sm:ml-3 lg:ml-5'>Add guests</p>
                    </div>
                    <div className='flex mx-5 my-2 items-center ' >
                        <img className='w-5' src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Google_Meet_icon_%282020%29.svg/2491px-Google_Meet_icon_%282020%29.svg.png" alt="google meet" />
                        <p className='sm:text-sm  lg:text-lg sm:ml-3 lg:ml-4 p-2 rounded-md bg-blue-500 text-white'>Add Google Meet Video Conferencing</p>
                        <div className='p-2 border-l-2 sm:text-sm lg:text-lg  border-l-white rounded-md text-white bg-blue-500'><i class="fi fi-sr-caret-down"></i></div>
                    </div>
                    <div className='flex mx-5 my-2 items-center text-gray-500' >
                    ...
                    <div className='flex mx-5 my-2 items-center text-gray-500' >
                        ...
                        <p className='sm:text-sm  lg:text-lg sm:ml-3 lg:ml-5'>kazi Ahmed Raza</p>
                        <div className='w-3 ml-2 p-2 bg-blue-500  rounded-full'></div>
                    </div>
